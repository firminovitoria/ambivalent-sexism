...
Original file is located at
    https://colab.research.google.com/drive/1KaamUC3q0nTNgrBUSwgfCn7ibCZ5YhMK
...
model = AutoModelForSequenceClassification.from_pretrained('melll-uff/bertweetbr', num_labels=3)
