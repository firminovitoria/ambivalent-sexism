# -*- coding: utf-8 -*-
"""bertabaporu-base.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1d9wZznTjN2nymtt0uHX8Lle5jS4qrjAo
...
tokenizer = BertTokenizer.from_pretrained('pablocosta/bertabaporu-base-uncased')
model = BertForSequenceClassification.from_pretrained('pablocosta/bertabaporu-base-uncased', num_labels=3)
...
tokenizer = BertTokenizer.from_pretrained('pablocosta/bertabaporu-base-uncased')
model = BertModel.from_pretrained('pablocosta/bertabaporu-base-uncased')
