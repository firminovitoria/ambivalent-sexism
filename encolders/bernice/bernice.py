...
Original file is located at
    https://colab.research.google.com/drive/1W9lKp0V1yiz4I_ejKyqUQ8K0iAe3OQry
...
model = AutoModelForSequenceClassification.from_pretrained('jhu-clsp/bernice', num_labels=3)
...
tokenizer = AutoTokenizer.from_pretrained('jhu-clsp/bernice')
model = AutoModel.from_pretrained('jhu-clsp/bernice')
